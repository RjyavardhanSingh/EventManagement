...
public class Library {
	...
	private void initialize() {
		...
		JLabel lblIntegratedLibrarySystem = new JLabel("LRC MANAGEMENT SYSTEM");
		lblIntegratedLibrarySystem.setBackground(Color.GRAY);
		lblIntegratedLibrarySystem.setFont(new Font("Tahoma", Font.PLAIN, 23));
		
		JLabel lblNewLabel = new JLabel("");
		// Image img=new ImageIcon(this.getClass().getResource("D:\\Downloads\\Integrated-Library-Management-System-master\\Integrated-Library-Management-System-master\\img\\book.png")).getImage();
